...
class ImageTasksApiTests(unittest.TestCase):
    ...
    def test_create_generation_task(self):
        ...
        self.assertEqual(self.fake_service.generation_calls[0][1]["account_type"], "paid")
        self.assertEqual(self.fake_service.generation_calls[0][1]["size"], "2048x2048")
        self.assertEqual(self.fake_service.generation_calls[0][1]["quality"], "high")
    ...
    def test_create_edit_task_accepts_multiple_images(self):
        ...
        self.assertEqual(self.fake_service.edit_calls[0][1]["account_type"], "paid")
        self.assertEqual(self.fake_service.edit_calls[0][1]["size"], "1024x1024")
        self.assertEqual(self.fake_service.edit_calls[0][1]["quality"], "medium")

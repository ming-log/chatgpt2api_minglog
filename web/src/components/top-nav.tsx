...
import { ImageQuotaPill } from "@/components/image-quota-pill";
import { TaskActivityPill } from "@/components/task-activity-pill";
...
export function TopNav() {
  ...
  if (normalizePath(pathname || "/") === "/login" || session === undefined || !session) {
    return null;
  }
  ...
  return (
    <header className="fixed top-0 right-0 left-0 z-40 border-b border-border/40 bg-background/55 backdrop-blur-[28px] backdrop-saturate-150">
      <div className="mx-auto flex h-14 max-w-[1440px] items-center gap-3 px-4 sm:h-16 sm:gap-4 sm:px-6 lg:px-8">
        ...
        <div className="flex shrink-0 items-center justify-end gap-2">
          <ImageQuotaPill />
          <TaskActivityPill />
          <span className="hidden items-center gap-1.5 rounded-full border border-border/70 bg-card px-2.5 py-1 text-[11px] leading-none text-muted-foreground lg:inline-flex">
          ...
          <span className="hidden items-center gap-1.5 rounded-full border border-border/70 bg-card px-2.5 py-1 text-[11px] leading-none md:inline-flex">
            <span className="grid size-4 place-items-center rounded-full bg-foreground text-[8px] font-bold text-background">
          ...
          <button
            type="button"
            className="cursor-pointer rounded-full border border-transparent px-2.5 py-1 text-[13px] font-bold leading-none text-muted-foreground transition hover:border-border/70 hover:bg-card hover:text-foreground"

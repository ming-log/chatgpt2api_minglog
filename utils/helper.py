...
TRANSIENT_UPSTREAM_CONNECTION_MARKERS = (
    "curl: (18)",
    "curl: (28)",
    "curl: (52)",
    "curl: (56)",
...
def is_transient_upstream_connection_error(error: object) -> bool:
    text = str(error or "").lower()
    return bool(text) and any(marker in text for marker in TRANSIENT_UPSTREAM_CONNECTION_MARKERS)

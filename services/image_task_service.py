...
def _public_task(task: dict[str, Any]) -> dict[str, Any]:
    item = {
        ...
        "account_type": normalize_image_account_category(task.get("account_type"), "free"),
        "size": task.get("size"),
...
class ImageTaskService:
    ...
    def submit_generation(
        ...
        *,
        ...
        normalized_account_type = normalize_image_account_category(account_type, "free")
        payload = {
            "prompt": prompt,
            "model": model,
        ...
        *,
        ...
        with self._lock:
            ...
            task = {
                ...
                "account_type": normalize_image_account_category(payload.get("account_type"), "free"),
    ...
    def _run_task(
        ...
        try:
            ...
            self._log_call(
                ...
                mode,
                model,
                _clean(payload.get("account_type"), "free"),
                started,
                "调用完成",
    ...
    def _load_locked(self) -> dict[str, dict[str, Any]]:
        ...
        for item in raw_items:
            ...
            task = {
                ...
                "account_type": normalize_image_account_category(item.get("account_type"), "free"),

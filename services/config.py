...
class ConfigStore:
    ...
    @property
    def console_request_log_enabled(self) -> bool:
        return _normalize_bool(
            os.getenv("CHATGPT2API_CONSOLE_REQUEST_LOG", self.data.get("console_request_log_enabled")),
            True,
        )

    @property
    def ppt_plan_stream_log_enabled(self) -> bool:
        return _normalize_bool(
            os.getenv("CHATGPT2API_PPT_PLAN_STREAM_LOG", self.data.get("ppt_plan_stream_log_enabled")),
            True,
        )
    ...
    def get(self) -> dict[str, object]:
        ...
        data["console_request_log_enabled"] = self.console_request_log_enabled
        data["ppt_plan_stream_log_enabled"] = self.ppt_plan_stream_log_enabled

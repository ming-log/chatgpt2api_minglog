...
def chat_image_args(body: dict[str, Any]) -> tuple[str, str, str, int, list[tuple[bytes, str, str]]]:
    model = str(body.get("model") or "gpt-image-2").strip() or "gpt-image-2"
    account_type = str(body.get("account_type") or "free").strip() or "free"
    ...
    return model, account_type, prompt, parse_image_count(body.get("n")), images
...
def image_chat_response(body: dict[str, Any]) -> dict[str, Any]:
    model, account_type, prompt, n, images = chat_image_args(body)
